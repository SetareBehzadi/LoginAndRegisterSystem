...
return [
    ...
    */
    ...
    'required_title'         => 'فیلد عنوان الزامی است.',
    ...
    */
    ...
    'custom' => [
        'image.required' => 'وارد کردن تصویر الزامیست'
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'is_active'             =>  'سوئیچ فعال بودن',
        'is_default'            =>  'سوئیچ پیشفرض بودن',
        'income_number'          =>  'شماره تراکنش',
        'from_income_type'       =>  'نوع درآمد',
        'branch'                  =>  'شعبه',
        'auto_code'                => 'گزینه تولید کد اتوماتیک',
        'parent_id'                => 'آی دی دسته مادر',
